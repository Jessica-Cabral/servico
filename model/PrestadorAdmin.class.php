...
class PrestadorAdmin extends Conexao
{
    // atributos
    private $id_pessoa;
    private $nome;
    ...
    public function consultarPrestadorAdmin()
    {
        $sql = "SELECT * FROM tb_pessoa ORDER BY id_pessoa";
    ...
    public function alterarPrestadorAdmin($id_pessoa,$nome,$telefone,$email,$status, $prestador)
    {
        ...
        $sql = "UPDATE tb_pessoa SET nome = :nome, telefone = :telefone, email = :email,status = :status, prestador = :prestador WHERE id_pessoa = :id_pessoa";
    ...
    public function excluirPrestadorAdmin($id_pessoa)
    {
        $this->setIdPessoa($id_pessoa);
    ...
    public function consultarDadosPrestadorAdmin($id_pessoa)
    {
        $this->setIdPessoa($id_pessoa);
    ...
    public function cadastrarPrestadorAdmin($cpf, $email, $data_nascimento, $telefone, $prestador)
    {
        $this->setEmail($email);
        $this->setCpf($cpf);
        ...
        $sql = "INSERT INTO tb_pessoa
            (id_pessoa, email, cpf, data_nascimento, data_cadastro, telefone, prestador)
            VALUES (NULL, :email, :cpf, :data_nascimento, now(), :telefone, :prestador)";
