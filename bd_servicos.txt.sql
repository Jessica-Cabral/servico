...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05/07/2025 às 01:12
...
--
-- Estrutura para tabela `solicitacao_servicos`
--
...
(7, 17, 'servico_17_1751640639_0.jpg', '2025-07-04 11:50:39'),
(8, 18, 'servico_18_1751640663_0.jpg', '2025-07-04 11:51:03'),
(9, 19, 'servico_19_1751640775_0.jpg', '2025-07-04 11:52:55');
...
(2, 'Maria Santos', 'maria.santos@email.com', '$2y$12$5CbWdHHDDvgmhmTT5Dn2quXVmzDyhsapz8ttRMkKmrxQufjPyY05a', '11122233344', '(11) 91111-1111', '2012-10-15', NULL, '2025-06-28 00:41:02', '2025-07-01 21:02:50', 1, 'prestador'),
...
(8, 'ERIVAN MENDES DA SILVA', 'mendesilva16@gmail.com', '$2y$12$RhVx53CVedN1nvIFxvmTxeN7l8i0XkqnI5f8YVJj5CvX1GAt1rzHG', NULL, NULL, NULL, NULL, '2025-06-30 22:23:02', '2025-06-30 22:23:25', 1, 'cliente'),
...
(10, 'João Prestador', 'prestador@email.com', '$2y$12$3IQ5AeifdmDV5Dk6a9ETDOFGVfwi4Y.ZbkTwzYOrZvF9Nv0LlYdQK', NULL, NULL, NULL, NULL, '2025-07-03 20:08:29', '2025-07-03 20:09:37', 1, 'prestador'),
...
(2, 2, 5, 120.00, 'Reparo da torneira com troca de vedações se necessário.', 1, '2025-06-28 00:41:02', 'aceita', NULL, NULL),
(3, 3, 6, 350.00, 'Pintura completa com preparação da parede e acabamento profissional.', 2, '2025-06-28 00:41:02', 'pendente', NULL, NULL),
(4, 12, 3, 200.00, 'eu pego o serviço\r\n', 3, '2025-07-03 21:27:47', 'pendente', NULL, NULL),
(5, 11, 3, 100.00, 'EU FACO', 2, '2025-07-03 21:31:22', 'pendente', NULL, NULL),
(6, 7, 3, 100.00, 'EU FACO', 2, '2025-07-03 21:31:39', 'recusada', NULL, '2025-07-04 09:17:53'),
(7, 3, 3, 400.00, 'EU FACO', 1, '2025-07-03 21:31:55', 'pendente', NULL, NULL),
(8, 12, 10, 600.00, 'eu faço o serviço em um dia o que acha?', 1, '2025-07-04 09:08:13', 'pendente', NULL, NULL),
(9, 14, 3, 400.00, 'faço em um dia', 1, '2025-07-04 10:35:09', 'pendente', NULL, NULL);
...
(11, 1, 4, 12, 'pintar', 'sei la', 7999.99, '2025-07-03 20:35:46', '2025-08-01 14:00:00', 1, 'alta', NULL, NULL),
...
(15, 1, 6, 10, 'Orientação para o Portfolio teste', 'bora faz', 5000.00, '2025-07-04 11:50:08', '2025-07-18 09:00:00', 1, 'alta', NULL, NULL),
(16, 1, 6, 10, 'Orientação para o Portfolio teste', 'bora faz', 5000.00, '2025-07-04 11:50:13', '2025-07-18 09:00:00', 1, 'alta', NULL, NULL),
(17, 1, 6, 10, 'Orientação para o Portfolio teste', 'bora faz', 5000.00, '2025-07-04 11:50:39', '2025-07-18 09:00:00', 6, 'alta', '2025-07-04 16:43:26', 'Não preciso mais do serviço'),
...
(19, 1, 6, 9, 'Abóbora ', 'fddg', 500.00, '2025-07-04 11:52:55', '2025-07-11 10:00:00', 1, 'media', NULL, NULL);
...
(6, 'Ar Condicionado', 'Instalação e manutenção de ar condicionado', 'Climatização', 200.00, 1, '2025-06-28 00:14:18', '2025-06-28 00:14:18'),
...
(1, 'Admin Sistema', 'admin@chamaservico.com', '$2y$10$WS/CGMNs1CdaiBGQT/OVLuwL/ZrUJ1cjJlgofGGWWHGpHw.kYbf1.', 'admin', '2025-06-27 19:39:34', 1);
...
--
-- Índices de tabela `solicitacao_servicos`
--
ALTER TABLE `solicitacao_servicos`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `solicitacao_servicos`
--
ALTER TABLE `solicitacao_servicos`
