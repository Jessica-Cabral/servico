...
<body>
    <div class="container-fluid">
        ...
        <form method="post" action="index.php">
            <div class="row">
                ...
                <div>
                    <button type="submit" name="consultar_pessoa_admin" class="btn btn-primary"><i
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                foreach ($resultado as $key => $valor) {
                    ...
                    print '  <td>
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#alterar_pessoa_admin' . $valor->id_pessoa . '"><i class="bi bi-pencil-square"></i> Alterar</button>
                                <button type="button" class="btn btn-danger"  data-bs-toggle="modal" data-bs-target="#excluir_pessoa' . $valor->id_pessoa . '"><i class="bi bi-x-square-fill"></i> Excluir</button>
                            </td>';
                    print '</tr>';
                }
                ?>
    ...
    <?php
        ...
        foreach ($resultado as $key => $valor) {
            $this->modal_excluir_pessoa_admin($valor->id_pessoa, $valor->nome);
        }
    ?>
    ...
    <?php
        ...
        foreach ($resultado as $key => $valor) {
            $this->modal_alterar_pessoa_admin(
                $valor->id_pessoa, 
                $valor->nome, 
