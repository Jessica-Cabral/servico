<div class="col-md-6 col-lg-4 mb-4 servico-card"
    ...
    data-valor="<?php echo htmlspecialchars($item['orcamento_estimado'] ?? ''); ?>">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center text-muted small">
                <span>
                    ...
                    <?php echo !empty($item['data_solicitacao']) ? date('d/m/Y', strtotime($item['data_solicitacao'])) : ''; ?>
                </span>
                <?php if ($item['orcamento_estimado'] ?? false): ?>
                    <span>
...
<!-- O componente chama verDetalhes(<?php echo $item['id']; ?>) em vários botões.
     Essa função precisa existir no JS global e deve montar a URL absoluta
     (/servico/...) ou abrir modal via AJAX para evitar que requisições relativas
     acabem retornando a página /servico/home. -->
