    ...
    <div class="modal fade" id="perfilModal" tabindex="-1" aria-labelledby="perfilModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header" style="background: linear-gradient(135deg, #31806a, #2db56b); color: #fff;">
                ...
                <form method="post" action="atualizar_perfil.php" enctype="multipart/form-data" id="formPerfil">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn" style="background: linear-gradient(135deg, #31806a, #2db56b); color: #fff;" id="btnEditarPerfil">Alterar Dados</button>
